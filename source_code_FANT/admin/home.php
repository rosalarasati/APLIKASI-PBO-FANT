          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                ...
                echo "Rp".number_format_short($total, 3)."</h3>";
              ?>
              <p>Total Penjualan</p>
            </div>
            <div class="icon">
            ...
            <a href="book.php" class="small-box-footer">Info lainnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="student.php" class="small-box-footer">Info lainnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="return.php" class="small-box-footer">Info Lainnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="borrow.php" class="small-box-footer">Info lainnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Laporan Penjualan Perbulan</h3>
...
<?php
  ...
  for( $m = 1; $m <= 12; $m++ ) {
    try{
      ...
      array_push($sales, round($total, 3));
    }
